...
namespace NGS.AdvancedCullingSystem.Static
{
    public class StaticCullingController : MonoBehaviour
    {
        ...
        {
            StaticCullingSource[] sources = FindObjectsByType<StaticCullingSource>(FindObjectsSortMode.None);
        ...
        private void ClearBakedData()
        {
            ...
            foreach (var target in FindObjectsByType<CullingTarget>(FindObjectsSortMode.None))
            {
