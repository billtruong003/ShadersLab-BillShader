...
{
    [CustomEditor(typeof(FreeObjectGhost)), CanEditMultipleObjects]
    public class FreeObjectGhostEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField("FREE OBJECT GHOST", style, GUILayout.ExpandWidth(true));
