...
{
    [CustomEditor(typeof(GridObjectGhost)), CanEditMultipleObjects]
    public class GridObjectGhostEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField("GRID OBJECT GHOST", style, GUILayout.ExpandWidth(true));
