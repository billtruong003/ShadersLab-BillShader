...
{
    [CustomEditor(typeof(BuildableEdgeObjectTypeSO)), CanEditMultipleObjects]
    public class BuildableEdgeObjectTypeSOEditor : Editor
    {
        ...
        {
            BuildableEdgeObjectTypeSO buildableEdgeObjectTypeSO = (BuildableEdgeObjectTypeSO)target;
            ...
            EditorGUILayout.LabelField("BUILDABLE EDGE OBJECT TYPE SO", style, GUILayout.ExpandWidth(true));
            ...
            if (buildableEdgeObjectTypeSO.showGridBelowObject)
            {
                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.PropertyField(objectGridCanvas);
                if (GUILayout.Button("Auto Set", GUILayout.Width(60)))
                {
                    buildableEdgeObjectTypeSO.objectGridCanvas = (Canvas)AssetDatabase.LoadAssetAtPath("Assets/EasyGridBuilder Pro/Prefabs/Canvas Grid Samples/Grid Canvas.prefab", typeof(Canvas));
                } 
