    ...
    public class MInputPlayerManager : MonoBehaviour
    {
        ...
        private void CameraLayerSettings(PlayerInput player)
        {
            ...
            foreach (var v in VirtualCams)
            {
                ...
                v.OutputChannel = (OutputChannels)player.playerIndex;
            }
            ...
            var cinebrain = player.transform.root.GetComponentInChildren<CinemachineBrain>();
             cinebrain.ChannelMask = (OutputChannels)player.playerIndex;
