...
public class ZonedPlacementGrid : PlacementGridBase
{
    ...
    [SerializeField] private LayerMask cellLayerMask = 1; // Default to layer 0
    ...
    private List<PlacementCell> GetCellsInBounds(Vector3 worldPosition, PlaceableObjectDataSO objectData, Quaternion rotation)
    {
        ...
        Collider[] hitColliders = Physics.OverlapBox(worldPosition, boxHalfExtents, transform.rotation * rotation, cellLayerMask, QueryTriggerInteraction.Collide);
