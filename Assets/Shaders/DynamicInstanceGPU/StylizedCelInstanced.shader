Shader "CleanCode/StylizedCelInstanced"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            StructuredBuffer < ObjectInstanceData> _VisibleBuffer;
            ...
            void Setup()
            {
                    ...
                    ObjectInstanceData data = _VisibleBuffer[unity_InstanceID];
            ...
            Varyings Vertex(Attributes input)
            {
                ...
                #ifdef UNITY_PROCEDURAL_INSTANCING_ENABLED
                    output.instanceColor = _VisibleBuffer[unity_InstanceID].color;
                #else
                        output.instanceColor = float4(1, 1, 1, 1);
                #endif
            ...
            half4 Fragment(Varyings input) : SV_Target
            {
                ...
                half4 albedo = SAMPLE_TEXTURE2D(_BaseMap, sampler_BaseMap, input.uv) * _BaseColor * input.instanceColor;
